    ...
    try {
      ...
      if (message.sender == currentUser) {
        ...
        if (message.isAudio == true) {
          deleteAudiofromBucket(oldAudioId: message.message);
          print("audio deleted from bucket");
        }
        
        if (message.isVideo == true) {
          deleteVideofromBucket(oldVideoId: message.message);
          print("video deleted from bucket");
        }
